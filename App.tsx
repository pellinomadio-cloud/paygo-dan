            ...
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-xl font-black text-purple-900 tracking-tight flex items-center justify-between dark:text-white">
                      6550197854
                      <button onClick={() => {navigator.clipboard.writeText('6550197854'); alert('Copied!');}} className="text-[9px] bg-purple-200 text-purple-700 px-2 py-0.5 rounded-md">COPY</button>
                    </p>
                </div>
                <div>
